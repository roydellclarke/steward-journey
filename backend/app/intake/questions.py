...
SECTIONS: list[dict[str, Any]] = [
    {
        ...
        "questions": [
            _q("biz_category", "business", "category",
               "Is this a founder-led or family business?", "single",
               options=_opts(
                   ("founder-led business", "Founder-led (you built or run it)"),
                   ("family", "Family business"),
                   ("partnership", "Partnership"),
                   ("other", "Something else"),
               ),
               why="It tells us how ownership works, and whether to ask about family. Your industry comes next."),
            _q("biz_industry", "business", "industry",
               "What industry or trade are you in?", "text",
               placeholder="e.g. HVAC, specialty manufacturing, accounting"),
